...
loadshape_module = LoadShapeNrel()
# df = loadshape_module.get_resstock_loadshape_by_state(state = "CA")
df = loadshape_module.get_comstock_loadshape_by_climatezone(climate = "very-cold")
# df = loadshape_module.get_comstock_loadshape_by_state(state = "CA")
# df = loadshape_module.get_comstock_loadshape_total()
print(df)


# loadshape_module.plot_loadshape(df)

print('github')

#  def plot_loadshape(df):
#     """plot the loadshape"""
#     t = np.linspace(0,24,len(df))
#     plt.plot(t, df["Electricity Total"]/1e3)
